...
import VIPRegistrationDialog from "@/components/VIPRegistrationDialog";

const Navbar = () => {
  const { isVIP, memberNumber } = useVIP();
        ...
        <div className="container mx-auto px-4 flex items-center justify-between h-18">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button
              ...
              className="bg-gradient-gold text-accent-foreground hover:opacity-90 hover:scale-105 rounded-lg font-semibold shadow-gold transition-all duration-300 animate-glow-pulse"
            >
              {isVIP ? "Mon Espace VIP" : "Connexion"}
            </Button>
